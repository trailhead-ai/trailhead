...
def render_dated_index(folder_name: str, folder: Path, date_keys: list[str]) -> str:
    ...
    lines = [
        ...
        "",
        "_Auto-generated by `plugins/lore/scripts/regenerate_indices.py`. "
        "Sorted by follow-up date (descending). Edit source files, not this index._",
        "",
        f"**Total:** {len(items)}",
        "",
    ]
...
def render_deferred_index(folder_name: str, folder: Path) -> str:
    ...
    lines = [
        ...
        "",
        "_Auto-generated by `plugins/lore/scripts/regenerate_indices.py`. "
        "Sorted by value (high → low), then effort (XS → XL), then date (newest first). "
        "Items in the same `consolidation-group` cluster within their tier. "
        "Edit source files, not this index._",
        "",
    ...
    if open_items:
        ...
        for value, effort, group, d, p, title, summary, status, revisit in open_items:
            g_disp = group or "—"
            lines.append(
                f"| {value} | {effort} | {g_disp} | {link_with_title(p, title)} "
                f"| {revisit} | {summary} |"
            )
        lines.append("")
...
def render_lessons_index(folder_name: str, folder: Path) -> str:
    ...
    lines = [
        ...
        "",
        "_Auto-generated by `plugins/lore/scripts/regenerate_indices.py`. "
        "Grouped by primary area; newest first within each group. "
        "Edit source files, not this index._",
        "",
...
def render_status_index(folder_name: str, folder: Path) -> str:
    ...
    lines = [
        ...
        "",
        "_Auto-generated by `plugins/lore/scripts/regenerate_indices.py`. "
        "Grouped by status; within each bucket, newest first. Edit source files, not this index._",
        "",
        f"**Total:** {total}  ·  "
