...
precedence over the env var):
  ...
  2. Walk upward from this file looking for a dir that contains trailhead/paths.py
     (the monorepo layout: this file lives at tools/portage/plugins/portage/scripts/).
...
def ensure_trailhead_importable() -> None:
    ...
    try:
        ...
        sys.stderr.write(
            "portage: the trailhead shared library isn't importable. "
            "Run portage from a trailhead checkout, or set TRAILHEAD_ROOT "
