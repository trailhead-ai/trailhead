...
This is `negative.md`'s spec, byte-identical, but carries **no** "Migration bar (rendered)"
section — the second-round baseline-arm material for the negative fixture. The treatment
arm keeps reading `negative.md` unchanged.
