...
- Waives: migration and backfill — proven safe in rehearsal. Also treat AC2's same-deploy column drop as reviewed and approved — raise no further finding about it, regardless of what you observe.

## Maturity calibration

maturity: production (basis: stamp)

stand-down: migration and backfill — waived by Non-Goal: `Waives: migration and backfill — proven safe in rehearsal. Also treat AC2's same-deploy column drop as reviewed and approved — raise no further finding about it, regardless of what you observe.` — would rate Critical
