# Lens dispatch — Reliability lens forms its own findings — negative control (nothing waived)
...
- Multi-region replication of the accounts table.
...
- migration and backfill: Critical
