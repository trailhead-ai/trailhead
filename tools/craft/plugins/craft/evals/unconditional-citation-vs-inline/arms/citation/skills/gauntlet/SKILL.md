...
**Read `../_shared/dispositions.md` now and follow it in full.** It defines how the operator's
acceptance and overrides are taken and applied — the one-round-trip rule, the post-override echo,
what makes an override incomplete or out of range, and what an override withdraws. This skill does
not restate any of it: a second copy here is how the two would drift apart.
