...
> dispute C3 — that workspace's audit store is being replaced next quarter and the new one
> carries its own retention policy, so pinning a window here would just be wrong twice.
> Otherwise go.
