"""Content contract for `plugins/craft/skills/shelve/SKILL.md`.
...
SKILL = (
    ...
    / "plugins" / "craft" / "skills" / "shelve" / "SKILL.md"
)
...
def test_which_backend_declaration_present(text: str):
    ...
    assert "writing local craft handoff at" in text
