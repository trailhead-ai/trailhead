# Fixture: a partial-coverage token is not a valid identifier list
...
- **First slice** — a fixture value claim. (`task/first`, closed 2026-01-01, partially covers the approval flow)
