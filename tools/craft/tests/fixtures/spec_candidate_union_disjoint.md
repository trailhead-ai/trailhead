# Fixture: two ledger lines each covering a disjoint subset
...
- **First slice** — a fixture value claim. (`task/first`, closed 2026-01-01, covers AC1, AC3)
- **Second slice** — a fixture value claim. (`task/second`, closed 2026-01-02, covers AC2, AC4)
