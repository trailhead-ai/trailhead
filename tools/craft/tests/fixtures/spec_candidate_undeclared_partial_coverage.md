# Fixture: a partial-coverage token names an identifier the spec never declares
...
- **First slice** — a fixture value claim. (`task/first`, closed 2026-01-01, partially covers AC1, AC99)
