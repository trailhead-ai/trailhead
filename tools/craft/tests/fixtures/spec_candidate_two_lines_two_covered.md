# Fixture: nine-criterion spec with two ledger lines covering one identifier each
...
- **First slice** — a fixture value claim. (`task/first`, closed 2026-01-01, covers AC1)
- **Second slice** — a fixture value claim. (`task/second`, closed 2026-01-02, covers AC2)
