"""Injectable runner protocol for release scripts (R-1, S-4).

Every gh/git call in the re-homed release scripts goes through this module.
Production code calls run(...) with no runner argument. Tests inject a stub
callable to capture calls without touching real gh/git or the network.
