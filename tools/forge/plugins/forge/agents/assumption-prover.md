...
- Place the test somewhere it can run alongside the existing suite, even though it's ephemeral. The executor will remove it later — note exactly which file(s) and line ranges to clean up in your report.
