...
- **a knowledge-synthesis subagent if one is configured (e.g. `lore:librarian`)** — prior UX decisions, design-system notes, brand/voice conventions in the project knowledge vault.
