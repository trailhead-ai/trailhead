...
Behavioural eval cases for camp's own prose — workspace provisioning, group resolution, and the launch/pretrust path.
...
Results go in `tools/camp/MANUAL-EVAL.md`.
