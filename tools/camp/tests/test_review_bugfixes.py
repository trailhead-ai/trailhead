...
class TestBug2RmRemovesWorkspaceDir:
    ...
    def test_after_rm_next_ai_takes_new_path(self, two_member_group, camp_cli, monkeypatch):
        ...
        g = two_member_group
        self._provision(g, "feat-cycle")
        reconcile_break(g["group"], "feat-cycle", env=g["env"])
