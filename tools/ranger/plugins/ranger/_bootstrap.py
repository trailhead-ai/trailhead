...
precedence over the env var):
  ...
  2. Walk upward from this file looking for a dir that contains trailhead/paths.py
     (the monorepo layout: this file lives at tools/ranger/plugins/ranger/).
...
def ensure_trailhead_importable() -> None:
    ...
    try:
        ...
        sys.stderr.write(
            "ranger: the trailhead shared library isn't importable. "
            "Run ranger from a trailhead checkout, or set TRAILHEAD_ROOT "
